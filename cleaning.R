...
z<-data.frame(Date=c(as.Date("2016-04-16")), 
              AQI=63,level = "良",PM25=37.5,PM10=71,SO2=0.65,CO=9,NO2=37,O3_8h=91)
...
z<-data.frame(Date=c(as.Date("2015-01-26")), 
              AQI=209,level = "重度污染",PM25=168,PM10=32.5,SO2=19.5,CO=1.85,NO2=47.5,O3_8h=44.5)
...
z<-data.frame(Date=c(as.Date("2015-01-26")), 
              AQI=189,level = "中度污染",PM25=149.5,PM10=57.5,SO2=20.5,CO=1.6,NO2=47.5,O3_8h=27.5)
...
z<-data.frame(Date=c(as.Date("2015-02-01")), 
              AQI=97.5,level = "良",PM25=73.5,PM10=18.5,SO2=15.5,CO=1.2,NO2=41,O3_8h=25.5)
changsha<- rbind(rbind(head,z),tail)
...
z<-data.frame(Date=c(as.Date("2016-09-9")), 
              AQI=70.5,level = "良",PM25=34,PM10=61.5,SO2=0.6,CO=3.5,NO2=37,O3_8h=119)
beijing[615,1:9] <- z
